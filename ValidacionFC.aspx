<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="ValidacionFC.aspx.vb" Inherits="ATVContraloria.ValidacionFC" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Importación : </span><span class="fontTitulo1b">Validación Flujo Caja Mensual</span></td>
