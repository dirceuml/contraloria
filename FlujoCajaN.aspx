<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="FlujoCajaN.aspx.vb" Inherits="ATVContraloria.FlujoCajaN" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Mantenimientos : </span><span class="fontTitulo1b">Flujo de Caja (Nuevo Formato)</span></td>
...
<tr>
    ...
    <asp:GridView ID="gdvCtaFlujoNRep" runat="server" AutoGenerateColumns="False" Width="98%"
        BorderWidth="1px" BorderColor="#4d81b3" CellPadding="3" ShowFooter="true"
        GridLines="Both" DataKeyNames="IdCtaFlujoNRep" 
        onrowdatabound="gdvCtaFlujoNRep_RowDataBound"
        onrowediting="gdvCtaFlujoNRep_RowEditing" 
        OnRowDeleting="gdvCtaFlujoRep_RowDeleting"
        onrowcancelingedit="gdvCtaFlujoNRep_RowCancelingEdit" 
        onrowupdating="gdvCtaFlujoNRep_RowUpdating" >                                
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Cuenta" ItemStyle-HorizontalAlign="left" ControlStyle-CssClass="fontText10" >
                <ItemTemplate><%# Eval("CtaFlujoNRep")%></ItemTemplate>
                <EditItemTemplate><asp:TextBox ID="txtCtaFlujoNRep" runat="server" Text='<%# Bind("CtaFlujoNRep")%>' Width="200px" CssClass="fontText10" ></asp:TextBox></EditItemTemplate>
                <FooterTemplate><asp:TextBox ID="txtCtaFlujoNRepNew" runat="server" Text='' CssClass="fontText10" ></asp:TextBox></FooterTemplate>
            </asp:TemplateField>
