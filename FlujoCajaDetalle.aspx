<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="FlujoCajaDetalle.aspx.vb" Inherits="ATVContraloria.FlujoCajaDetalle" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Mantenimientos : </span><span class="fontTitulo1b"><a href="FlujoCaja.aspx" style="text-decoration:underline;">Flujo de Caja</a> -> Detalle</span></td>
...
<asp:HiddenField ID="hdfIdCtaFlujoRep" Value="" runat="server" />
<table border="0" cellspacing="0" cellpadding="5" width="90%" align="center">
<tr><td><span class="fontText12"><b>&nbsp;&nbsp;&nbsp;Cuenta: <asp:Label ID="lblCtaFlujoRep" runat="server" Text="lblCtaFlujoRep"></asp:Label></b></span></td></tr>
<tr>
    <td>
    ...
    <asp:GridView ID="gdvCtaDetalleRep" runat="server" AutoGenerateColumns="False" Width="98%"
        BorderWidth="1px" BorderColor="#4d81b3" CellPadding="3" ShowFooter="true"
        GridLines="Both" DataKeyNames="IdCtaDetalleRep" 
        onrowdatabound="gdvCtaDetalleRep_RowDataBound"
        onrowediting="gdvCtaDetalleRep_RowEditing" 
        OnRowDeleting="gdvCtaDetalleRep_RowDeleting"
        onrowcancelingedit="gdvCtaDetalleRep_RowCancelingEdit" 
        onrowupdating="gdvCtaDetalleRep_RowUpdating" >                                
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Cuenta Detalle" ItemStyle-HorizontalAlign="left" ControlStyle-CssClass="fontText10" >
                <ItemTemplate>&nbsp;<%# Eval("CtaDetalleRep")%></ItemTemplate>
                <EditItemTemplate><asp:TextBox ID="txtCtaDetalleRep" runat="server" Text='<%# Bind("CtaDetalleRep")%>' Width="200px" CssClass="fontText10" ></asp:TextBox></EditItemTemplate>
                <FooterTemplate><asp:TextBox ID="txtCtaDetalleRepNew" runat="server" Text='' CssClass="fontText10" ></asp:TextBox></FooterTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Signo" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate><asp:Label ID="lnkSigno" runat="server" Text="lnkSigno" ></asp:Label></ItemTemplate>
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Cta Origen" ItemStyle-HorizontalAlign="left">
                <ItemTemplate>&nbsp;<asp:Label ID="lnkCodCtaOrigen" runat="server" Text="lnkCodCtaOrigen" ></asp:Label></ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Tipo Detalle" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate><asp:Label ID="lnkTipoDetalle" runat="server" Text="lnkTipoDetalle" ></asp:Label></ItemTemplate>
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Acción" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
