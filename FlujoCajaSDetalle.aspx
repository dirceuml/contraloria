<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="FlujoCajaSDetalle.aspx.vb" Inherits="ATVContraloria.FlujoCajaSDetalle" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Mantenimientos : </span><span class="fontTitulo1b"><a href="FlujoCajaS.aspx" style="text-decoration:underline;">Flujo de Caja</a> -> Detalle</span></td>
...
<asp:HiddenField ID="hdfCodDetalle" Value="" runat="server" />
<table border="0" cellspacing="0" cellpadding="5" width="90%" align="center">
<tr><td><span class="fontText12"><b>&nbsp;&nbsp;&nbsp;Código: <asp:Label ID="lblCodDetalle" runat="server" Text="lblCodDetalle"></asp:Label></b></span></td></tr>
<tr>
    <td>
    ...
    <asp:GridView ID="gdvCtaDetalleS" runat="server" AutoGenerateColumns="False" Width="98%"
        BorderWidth="1px" BorderColor="#4d81b3" CellPadding="3" ShowFooter="true"
        GridLines="Both" DataKeyNames="IdCtaDetalle" 
        onrowdatabound="gdvCtaDetalleS_RowDataBound"
        onrowediting="gdvCtaDetalleS_RowEditing" 
        OnRowDeleting="gdvCtaDetalleS_RowDeleting"
        onrowcancelingedit="gdvCtaDetalleS_RowCancelingEdit" 
        onrowupdating="gdvCtaDetalleS_RowUpdating" >                                
