<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="EOAFDetalle.aspx.vb" Inherits="ATVContraloria.EOAFDetalle" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Mantenimientos : </span><span class="fontTitulo1b"><a href="EOAF.aspx" style="text-decoration:underline;">Origen Aplicacion Fondos</a> -> Detalle</span></td>
...
<asp:HiddenField ID="hdfIdCtaEOAF" Value="" runat="server" />
<table border="0" cellspacing="0" cellpadding="5" width="90%" align="center">
<tr><td><span class="fontText12"><b>&nbsp;&nbsp;&nbsp;<asp:Label ID="lblCtaEOAF" runat="server" Text=""></asp:Label></b></span><br /><br /></td></tr>
<tr>
    <td>
    ...
    <asp:GridView ID="gdvCtaEOAFDet" runat="server" AutoGenerateColumns="False" Width="98%"
        BorderWidth="1px" BorderColor="#4d81b3" CellPadding="3" ShowFooter="true"
        GridLines="Both" DataKeyNames="IdCtaEOAFDet" >                                
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Cuenta" ItemStyle-HorizontalAlign="Left" SortExpression="Cuenta">
                <ItemTemplate><%# Eval("CuentaFC")%></ItemTemplate>
                <EditItemTemplate>
                    <asp:DropDownList ID="cboCodCtaOrigen" runat="server" CssClass="fontText10" DataValueField="CodCuenta2" DataTextField="Cuenta2" ></asp:DropDownList>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:DropDownList ID="cboCodCtaOrigen" runat="server" CssClass="fontText10" DataValueField="CodCuenta2" DataTextField="Cuenta2" ></asp:DropDownList>
                </FooterTemplate>
