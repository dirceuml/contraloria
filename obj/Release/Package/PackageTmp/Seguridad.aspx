<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="Seguridad.aspx.vb" Inherits="ATVContraloria.Seguridad" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Mantenimientos : </span><span class="fontTitulo1b"><a href="Usuarios.aspx" style="text-decoration:underline;">Usuarios</a> -> Seguridad</span></td>
...
<asp:HiddenField ID="hdfIdUsuario" Value="" runat="server" />
<table border="0" cellspacing="0" cellpadding="5" width="90%" align="center">
<tr><td><span class="fontText12"><b>&nbsp;&nbsp;&nbsp;<asp:Label ID="lblUsuario" runat="server" Text=""></asp:Label></b></span><br /><br /></td></tr>
<tr>
    <td>
    ...
    <asp:GridView ID="gdvSeguridad" runat="server" AutoGenerateColumns="False" Width="98%"
        BorderWidth="1px" BorderColor="#4d81b3" CellPadding="3" ShowFooter="true"
        GridLines="Both" DataKeyNames="IdSeguridad" >                                
        <RowStyle BackColor="#FFFFFF" />
        <Columns>
            <asp:TemplateField HeaderText="Acceso" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left" >
                <ItemTemplate>&nbsp;<%# Eval("Acceso")%></ItemTemplate>
                <EditItemTemplate>
                    &nbsp;<asp:DropDownList ID="cboAcceso" runat="server" CssClass="fontText10" DataValueField="IdAcceso" DataTextField="SeccionAcceso" ></asp:DropDownList>
                </EditItemTemplate>
                <FooterTemplate>
                    &nbsp;<asp:DropDownList ID="cboAcceso" runat="server" CssClass="fontText10" DataValueField="IdAcceso" DataTextField="SeccionAcceso" ></asp:DropDownList>
                </FooterTemplate>
