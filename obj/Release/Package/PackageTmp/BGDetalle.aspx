<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="BGDetalle.aspx.vb" Inherits="ATVContraloria.BGDetalle" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Mantenimientos : </span><span class="fontTitulo1b"><a href="BG.aspx" style="text-decoration:underline;">Balance General</a> -> Detalle</span></td>
...
<asp:HiddenField ID="hdfIdCtaBG" Value="" runat="server" />
<table border="0" cellspacing="0" cellpadding="5" width="90%" align="center">
<tr><td><span class="fontText12"><b>&nbsp;&nbsp;&nbsp;<asp:Label ID="lblCtaBG" runat="server" Text=""></asp:Label></b></span><br /><br /></td></tr>
<tr>
    <td>
    ...
    <asp:GridView ID="gdvCtaBGDet" runat="server" AutoGenerateColumns="False" Width="98%"
        BorderWidth="1px" BorderColor="#4d81b3" CellPadding="3" ShowFooter="true"
        GridLines="Both" DataKeyNames="IdCtaBGDet" >                                
        <RowStyle BackColor="#FFFFFF" />
        <Columns>
            <asp:TemplateField HeaderText="Cuenta Contable SISMED" ItemStyle-HorizontalAlign="Left" >
