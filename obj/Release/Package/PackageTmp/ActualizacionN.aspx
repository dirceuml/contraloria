<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="ActualizacionN.aspx.vb" Inherits="ATVContraloria.ActualizacionN" EnableEventValidation ="false" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Actualización : </span><span class="fontTitulo1b">Cuentas Flujo Caja (nuevo formato)</span></td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contenido" runat="server">
    ...
    <tr class="TDList1">
        ...
        <td><asp:DropDownList ID="cboCuentaDestino" runat="server" CssClass="InputText10" onchange="Filtrar(this);" Width="280px" ></asp:DropDownList></td>
    </tr>
    <tr class="TDList0">
    ...
    <tr class="TDList0">
        ...
        <td></td>
        <td>
            <asp:Button ID="btnConsultar" runat="server" Text="Consultar" OnClick="btnConsultar_Click" OnClientClick="javascript:if (!ValidaConsulta() ) return false;" Height="20px" Width="120px" CssClass ="fontBoton" />
            <asp:Button ID="btnDescargaExcel" runat="server" Text="Descargar a Excel" onclick="btnDescargaExcel_Click" Height="20px" Width="120px" CssClass="fontBoton" />
        </td>
    </tr>
    </table>
    ...
    <tr>
        ...
        <asp:GridView ID="gdvMovimiento" runat="server" AllowPaging="True" AutoGenerateColumns="False" 
            BorderWidth="1px" BorderColor="#4d81b3" CellPadding="3" Width="98%" GridLines="Both" DataKeyNames="IdMovimiento" 
            onpageindexchanging="gdvMovimiento_PageIndexChanging"
            onrowdatabound="gdvMovimiento_RowDataBound" >                                
            <RowStyle BackColor="#FFFFFF" />
            <Columns>
                <asp:BoundField HeaderText="Nº" ReadOnly="true" ControlStyle-CssClass="fontText10" ></asp:BoundField>
                <asp:BoundField HeaderText="Periodo" DataField="IdPeriodo" ReadOnly="true" ControlStyle-CssClass="fontText10" ></asp:BoundField>
                <asp:BoundField HeaderText="Bco." DataField="CodCuentaBanco" ItemStyle-HorizontalAlign="left" Visible="false"></asp:BoundField>
                <asp:BoundField HeaderText="Cta.Banco" DataField="CuentaBanco" ItemStyle-HorizontalAlign="left" ReadOnly="true" ControlStyle-CssClass="fontText10" ></asp:BoundField>
                <asp:BoundField HeaderText="Vou" DataField="NroVoucher" ItemStyle-HorizontalAlign="center" ReadOnly="true" ControlStyle-CssClass="fontText10" ></asp:BoundField>
                <asp:BoundField HeaderText="Item" DataField="NroItem" ItemStyle-HorizontalAlign="center" ReadOnly="true" ControlStyle-CssClass="fontText10" ></asp:BoundField>
                <asp:BoundField HeaderText="Fecha" DataField="Fecha" ItemStyle-HorizontalAlign="left" ReadOnly="true" ControlStyle-CssClass="fontText10" DataFormatString="{0:dd/MM/yy}" ></asp:BoundField>
                <asp:BoundField HeaderText="CodCuentaFC" DataField="CodCuentaFC" ItemStyle-HorizontalAlign="left" Visible="false"></asp:BoundField>
                <asp:BoundField HeaderText="Cta.Caja" DataField="CuentaFC" ItemStyle-HorizontalAlign="left" ReadOnly="true" ControlStyle-CssClass="fontText10" ></asp:BoundField>
        ...
        <asp:GridView ID="gdvResultadosExp" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                    ...
                    <asp:BoundField HeaderText="Cod.Cta.Banco" DataField="CodCuentaBanco" Visible="false"></asp:BoundField>
                    ...
                    <asp:BoundField HeaderText="Cod.Cta.Caja" DataField="CodCuentaFC" Visible="false"></asp:BoundField>
                    <asp:BoundField HeaderText="Cta.Caja" DataField="CuentaFC" />
                    <asp:TemplateField HeaderText="Cta.Nueva">
                        <ItemTemplate><asp:Label ID="lnkCuentaDestino" runat="server" Text="lnkCuentaDestino"></asp:Label></ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="CodPersona" DataField="CodPersona" Visible="false"></asp:BoundField>
                    <asp:BoundField HeaderText="Persona" DataField="Persona" />
                    <asp:BoundField HeaderText="Glosa" DataField="Glosa" />
                    <asp:BoundField HeaderText="Observaciones" DataField="Observaciones" />
                    <asp:BoundField HeaderText="Area" DataField="Area" />
                    <asp:TemplateField HeaderText="Area Nueva">
                        <ItemTemplate><asp:Label ID="lnkAreaNueva" runat="server" Text="lnkAreaNueva"></asp:Label></ItemTemplate>
                    </asp:TemplateField>
    ...
    <asp:Panel ID="pnlDetalle" runat="server" Width="800px" BorderWidth="0px" CssClass="modalPopup" BackColor="#FFFFFF">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr class="TDList0">
                ...
                <td><asp:DropDownList ID="cboCuentaFCN" runat="server" CssClass="fontTextSmall" ></asp:DropDownList></td>
                <td><font class="fontText10">Area Nueva</font></td>
                <td><asp:DropDownList ID="cboAreaN" runat="server" CssClass="fontTextSmall" ></asp:DropDownList></td>
            </tr>
            <tr class="TDList1"><td colspan="4"><img src="images/trans.gif" width="10px" height="10px" alt=""></td></tr>
