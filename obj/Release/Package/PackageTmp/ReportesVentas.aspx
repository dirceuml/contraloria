<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="ReportesVentas.aspx.vb" Inherits="ATVContraloria.ReportesVentas" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Reportes : </span><span class="fontTitulo1b">Ventas</span></td>
...
<asp:Content ID="contenido" ContentPlaceHolderID="contenido" runat="server">
    ...
    <asp:LinkButton ID="lnkGenerarReporte" runat="server" Font-Size="Small">Generar Reporte Ventas</asp:LinkButton>
