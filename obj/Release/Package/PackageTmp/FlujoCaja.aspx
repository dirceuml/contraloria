<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="FlujoCaja.aspx.vb" Inherits="ATVContraloria.FlujoCaja" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Mantenimientos : </span><span class="fontTitulo1b">Flujo de Caja - Mensual</span></td>
...
<tr>
    ...
    <asp:GridView ID="gdvCtaFlujoRep" runat="server" AutoGenerateColumns="False" Width="98%"
        BorderWidth="1px" BorderColor="#4d81b3" CellPadding="3" ShowFooter="true"
        GridLines="Both" DataKeyNames="IdCtaFlujoRep" 
        onrowdatabound="gdvCtaFlujoRep_RowDataBound"
        onrowediting="gdvCtaFlujoRep_RowEditing" 
        OnRowDeleting="gdvCtaFlujoRep_RowDeleting"
        onrowcancelingedit="gdvCtaFlujoRep_RowCancelingEdit" 
        onrowupdating="gdvCtaFlujoRep_RowUpdating" >                                
        <RowStyle BackColor="#FFFFFF" />
        <Columns>
            <asp:TemplateField HeaderText="Detalle" ItemStyle-Width="50">
            ...
            <asp:TemplateField HeaderText="Orden" ItemStyle-Width="50" ItemStyle-HorizontalAlign="center" ControlStyle-CssClass="fontText10" >
                ...
                <FooterTemplate><asp:TextBox ID="txtOrdenNew" runat="server" Text='' Width="30px" CssClass="fontText10" ></asp:TextBox></FooterTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Cuenta" ItemStyle-HorizontalAlign="left" ControlStyle-CssClass="fontText10" >
                <ItemTemplate><%# Eval("CtaFlujoRep")%></ItemTemplate>
                <EditItemTemplate><asp:TextBox ID="txtCtaFlujoRep" runat="server" Text='<%# Bind("CtaFlujoRep")%>' Width="200px" CssClass="fontText10" ></asp:TextBox></EditItemTemplate>
                <FooterTemplate><asp:TextBox ID="txtCtaFlujoRepNew" runat="server" Text='' Width="200px" CssClass="fontText10" ></asp:TextBox></FooterTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Auxiliar" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate><%# Eval("CodAuxiliar")%></ItemTemplate>
                <EditItemTemplate><asp:DropDownList ID="cboCodAuxiliar" runat="server" CssClass="fontText10" ></asp:DropDownList></EditItemTemplate>
                <FooterTemplate><asp:DropDownList ID="cboCodAuxiliarNew" runat="server" CssClass="fontText10" ></asp:DropDownList></FooterTemplate>
            </asp:TemplateField>
    ...
    <asp:GridView ID="gdvCtaFCExp" runat="server" AutoGenerateColumns="False" Visible="False">
    <Columns>
        <asp:BoundField HeaderText="Orden" DataField="OrdenC" ItemStyle-Width="50px"/>
        <asp:BoundField HeaderText="Signo" DataField="SignoC" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Center" />
        <asp:BoundField HeaderText="Cuenta Flujo Caja" DataField="CtaFlujoRep" ItemStyle-Width="300px" />
        <asp:BoundField HeaderText="Sección" DataField="CodSeccion" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="70px"/>
        <asp:BoundField HeaderText="Orden" DataField="OrdenD" ItemStyle-Width="50px"/>
        <asp:BoundField HeaderText="Cuenta Flujo Caja Detalle" DataField="CtaDetallerep" ItemStyle-Width="300px" />
        <asp:BoundField HeaderText="Signo" DataField="SignoD" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Center" />
        <asp:BoundField HeaderText="Cuenta Flujo Caja SISMED" DataField="Cuenta2" ItemStyle-Width="400px" />
    </Columns>
</asp:GridView>
    </div> 
    </td>
