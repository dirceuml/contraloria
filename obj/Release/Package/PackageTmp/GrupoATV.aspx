<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ATVContraloria.Master" CodeBehind="GrupoATV.aspx.vb" Inherits="ATVContraloria.GrupoATV" %>
...
<div class="barraherram">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablaCabTitFech">
    <tr>
      <td width="61%"><span class="fontTitulo1">Consultas : </span><span class="fontTitulo1b">Grupo ATV</span></td>
...
<tr>
    ...
    <asp:GridView ID="gdvGrupoATV" runat="server" AutoGenerateColumns="False" Width="98%"
        BorderWidth="1px" BorderColor="#4d81b3" CellPadding="3" ShowFooter="true"
        GridLines="Both" DataKeyNames="IdEmpresa" 
        onrowdatabound="gdvGrupoATV_RowDataBound"
        onrowediting="gdvGrupoATV_RowEditing" 
        OnRowDeleting="gdvGrupoATV_RowDeleting"
        onrowcancelingedit="gdvGrupoATV_RowCancelingEdit" 
        onrowupdating="gdvGrupoATV_RowUpdating" >                                
        ...
        <Columns>
            <asp:TemplateField HeaderText="Orden" HeaderStyle-Width="50" ItemStyle-HorizontalAlign="center" ControlStyle-CssClass="fontText10" >
                ...
                <FooterTemplate><asp:TextBox ID="txtOrdenNew" runat="server" Text='' Width="50px" CssClass="fontText10" ></asp:TextBox></FooterTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Empresa" ItemStyle-HorizontalAlign="left" ControlStyle-CssClass="fontText10" >
                <ItemTemplate><%# Eval("Empresa")%></ItemTemplate>
                <EditItemTemplate><asp:TextBox ID="txtEmpresa" runat="server" Text='<%# Bind("Empresa")%>' CssClass="fontText10" ></asp:TextBox></EditItemTemplate>
                <FooterTemplate><asp:TextBox ID="txtEmpresaNew" runat="server" Text='' CssClass="fontText10" ></asp:TextBox></FooterTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Persona" ItemStyle-HorizontalAlign="left">
                <ItemTemplate><%# Eval("Persona")%></ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Nivel" HeaderStyle-Width="50" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate><%# Eval("Nivel")%></ItemTemplate>
                <EditItemTemplate>
                    <asp:DropDownList ID="cboNivel" runat="server" CssClass="fontText10" >
                ...
                <FooterTemplate>
                    <asp:DropDownList ID="cboNivelNew" runat="server" CssClass="fontText10" >
                    <asp:ListItem Value="" Text=""></asp:ListItem>
                    <asp:ListItem Value="1" Text="1"></asp:ListItem>
                    <asp:ListItem Value="2" Text="2"></asp:ListItem>
                    </asp:DropDownList>
            ...
            <asp:TemplateField HeaderText="NivelN" HeaderStyle-Width="50" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate><%# Eval("NivelN")%></ItemTemplate>
                <EditItemTemplate>
                    <asp:DropDownList ID="cboNivelN" runat="server" CssClass="fontText10" >
                    <asp:ListItem Value="" Text=""></asp:ListItem>
                    <asp:ListItem Value="1" Text="1"></asp:ListItem>
                    <asp:ListItem Value="2" Text="2"></asp:ListItem>
                ...
                <FooterTemplate>
                    <asp:DropDownList ID="cboNivelNNew" runat="server" CssClass="fontText10" >
                    <asp:ListItem Value="" Text=""></asp:ListItem>
                    <asp:ListItem Value="1" Text="1"></asp:ListItem>
                    <asp:ListItem Value="2" Text="2"></asp:ListItem>
                    <asp:ListItem Value="3" Text="3"></asp:ListItem>
